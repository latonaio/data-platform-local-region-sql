...
(
  ...
  `IsMarkedForDeletion`   tinyint(1) DEFAULT NULL,
    ...
    CONSTRAINT `DPFMLocalRegionLocalSubRegionData_fk` FOREIGN KEY (`LocalRegion`, `Country`) REFERENCES `data_platform_local_region_local_region_data` (`LocalRegion`, `Country`)
